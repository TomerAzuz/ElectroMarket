...
function Header() {
  return (
    <header className="mx-auto bg-red-600 py-2 md:py-2 px-6 shadow-md fixed flex 
      ...
      <div className="cursor-pointer flex mt-2 md:mt-0 md:ml-0 md:mr-0 group flex-row">
        <Cart />
        <User />
      </div>
    </header>
