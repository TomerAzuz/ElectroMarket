...
function Hero() {
  ...
  return (
    <section className="h-auto lg:h-[800px] bg-hero bg-no-repeat bg-cover bg-center py-72 lg:py-32">
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center">
        ...
        <div className="max-w-[300px] mt-20 lg:mt-0 lg:w-full lg:max-w-[400px] mx-auto transition duration-300">
          <Carousel
            autoPlay
            infiniteLoop
            showThumbs={false}
            ...
            {imageUrls.map((imageUrl, index) => (
              <div key={index} className="image-container">
                <img
                  src={imageUrl}
                  alt={`Slide ${index}`}
                  className="w-full lg:w-96 md:w-80 sm:w-64 mx-auto"
                />
              </div>
            ))}
          </Carousel>
